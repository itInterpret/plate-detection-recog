...
void train_detector(char *datacfg, char *cfgfile, char *weightfile, int *gpus, int ngpus, int clear)
{
    ...
    char *train_images = option_find_str(options, "train", "data/train.list"); // 训练自己的数据集时，这里要进行相应的修改
    char *backup_directory = option_find_str(options, "backup", "/backup/");   // 训练自己的数据集时，这里要进行相应的修改
